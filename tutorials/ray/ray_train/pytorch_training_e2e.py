...
def main(data_size_gb: int, num_epochs=2, num_workers=1, smoke_test: bool = False):
    ...
    dataset = dataset.map_batches(add_fake_labels, num_cpus=1)
    dataset = dataset.map_batches(
        transform_image, fn_kwargs={"transform": transform}, num_cpus=2
    )
    ...
    trainer = TorchTrainer(
        ...
        run_config=RunConfig(storage_path="/home/ray/nfs"),
    )
    trainer.fit()
