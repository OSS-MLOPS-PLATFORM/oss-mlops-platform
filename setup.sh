...
RECOMMENDED_DISK_SPACE_KUBEFLOW_GB=$(($RECOMMENDED_DISK_SPACE / 1024 / 1024))
RECOMMENDED_DISK_SPACE_KFP=20971520
RECOMMENDED_DISK_SPACE_KFP_GB=$(($RECOMMENDED_DISK_SPACE / 1024 / 1024))
